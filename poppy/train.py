...
parser.add_argument('--rdrsegmenter_path', type=str, default='./models/VnCoreNLP-1.1.1.jar')
...
parser.add_argument('--bpe-codes', default="./PhoBERT_base/bpe.codes", 
                    type=str, help='path to fastBPE BPE')

args = parser.parse_args()

bpe = fastBPE(args)
rdrsegmenter_path = os.path.abspath(args.rdrsegmenter_path)
...
model_bert = RobertaClassifier.from_pretrained(args.pretrained_path, config=config)
model_bert.cuda()
